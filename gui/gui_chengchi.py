...
class ChengChiInfo(easy_pygame.GameObject):
    ...
    def update(self):
        ...
        self.info.set_font(('../wqy-zenhei.ttc',24))
        self.info.addline(self.chengchi,color=(255,255,0))
    ...
    def __init__(self,screen,chengchi):
        ...
        self.info=easy_pygame.Label(screen,self.pos,size=self.size,alpha=180,touch=True)
    ...
    def Event(self,event):
        ...
        if EVENT(event) ==MOUSE_LEFT_DOWN:
            if self._isin(event.pos,(0,360),(200,200)):
